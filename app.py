...
<head>  
    ...
    <style>  
        ...
        * {  
        ...
        .public-verification-section::before {  
            content:"";  
            position:absolute;  
            width:240px;  
            height:240px;  
        ...
        .public-verification-copy h3 {  
            font-size:28px;  
            line-height:1.2;  
            margin-bottom:14px;  
        }  
  
        .public-verification-copy p {  
            color:#cbd5e1;  
            font-size:15px;  
            line-height:1.7;  
            max-width:680px;  
        ...
        .public-verification-form label {  
            display:block;  
            color:var(--primary-color);  
            font-weight:800;  
            font-size:14px;  
        ...
        .public-verification-input:focus {  
            border-color:var(--accent-blue);  
            box-shadow:0 0 0 3px rgba(37,99,235,.12);  
        }  
  
        .public-verification-btn {  
            min-width:118px;  
            height:46px;  
            border:none;  
            border-radius:7px;  
        ...
        .public-verification-btn:hover {  
            transform:translateY(-1px);  
            box-shadow:0 7px 16px rgba(184,134,11,.25);  
        }  
  
        .public-verification-hint {  
            color:#64748b;  
            font-size:12px;  
            line-height:1.55;  
            margin-top:11px;  
...
<body>  
    ...
    >  
        ...
        <section  
            class="public-verification-section"  
            id="verification"  
            aria-labelledby="publicVerificationTitle"  
        >  
  
            <div class="public-verification-content">  
  
                <div class="public-verification-copy">  
  
                    <div  
                        class="public-verification-kicker"  
                        data-i18n="verify_kicker"  
                    >  
                        ✓ Verifica pubblica  
                    </div>  
  
                    <h3  
                        id="publicVerificationTitle"  
                        data-i18n="verify_title"  
                    >  
                        Verifica un record SinoTrust Europe  
                    </h3>  
  
                    <p data-i18n="verify_desc">  
                        Inserisci il codice riportato sul certificato, sul badge o nel QR code per controllare lo stato pubblico del record SinoTrust.  
                    </p>  
  
                </div>  
  
                <form  
                    class="public-verification-form"  
                    id="publicVerificationForm"  
                    novalidate  
                >  
  
                    <label  
                        for="publicVerificationCode"  
                        data-i18n="verify_label"  
                    >  
                        Codice di verifica  
                    </label>  
  
                    <div class="public-verification-row">  
  
                        <input  
                            class="public-verification-input"  
                            id="publicVerificationCode"  
                            ...
                            spellcheck="false"  
                            maxlength="80"  
                            placeholder="Es. ST-86D86F60B492EFBC"  
                            data-i18n-ph="verify_placeholder"  
                            aria-describedby="publicVerificationHint publicVerificationError"  
                        >  
  
                        <button  
                            class="public-verification-btn"  
                            type="submit"  
                    ...
                    <div  
                        class="public-verification-hint"  
                        id="publicVerificationHint"  
                        data-i18n="verify_hint"  
                    >  
                        Il record SinoTrust supporta la verifica digitale e non sostituisce eventuali certificazioni obbligatorie previste dalla legge.  
                    </div>  
  
                    <div  
                        class="public-verification-error"  
                        id="publicVerificationError"  
                        role="alert"  
                        aria-live="polite"  
                    ></div>  
...
与您取得联系  
    ...
    <script>  
        const translations = {  
            ...
            zh: {  
                ...
                verify_title:  
                    "验证 SinoTrust Europe 数字核验记录",  
  
                verify_desc:  
                    "输入证书、数字徽章或二维码上显示的验证代码，以查看 SinoTrust 记录的公开状态。",  
  
                verify_label:  
                    "验证代码",  
  
                verify_placeholder:  
                    "例如 ST-86D86F60B492EFBC",  
  
                verify_btn:  
                    "立即验证",  
  
                verify_hint:  
                    "SinoTrust 记录用于数字核验支持，不替代法律规定的强制性产品认证。",  
  
                verify_invalid:  
                    "请输入有效的 SinoTrust 验证代码。",  
            ...
            en: {  
                ...
                verify_title:  
                    "Verify a SinoTrust Europe record",  
  
                verify_desc:  
                    "Enter the verification code shown on a certificate, digital badge or QR code to check the public status of a SinoTrust record.",  
  
                verify_label:  
                    "Verification code",  
  
                verify_placeholder:  
                    "e.g. ST-86D86F60B492EFBC",  
  
                verify_btn:  
                    "Verify",  
  
                verify_hint:  
                    "A SinoTrust record supports digital verification and does not replace legally mandatory product certifications.",  
  
                verify_invalid:  
                    "Enter a valid SinoTrust verification code.",  
            ...
            it: {  
                ...
                verify_desc:  
                    "Inserisci il codice riportato sul certificato, sul badge digitale o nel QR code per controllare lo stato pubblico del record SinoTrust.",  
  
                verify_label:  
                    "Codice di verifica",  
  
                verify_placeholder:  
                    "Es. ST-86D86F60B492EFBC",  
                ...
                verify_invalid:  
                    "Inserisci un codice di verifica SinoTrust valido.",  
            ...
            de: {  
                ...
                verify_title:  
                    "SinoTrust-Europe-Eintrag verifizieren",  
  
                verify_desc:  
                    "Geben Sie den Verifizierungscode vom Zertifikat, digitalen Badge oder QR-Code ein, um den öffentlichen Status eines SinoTrust-Eintrags zu prüfen.",  
  
                verify_label:  
                    "Verifizierungscode",  
  
                verify_placeholder:  
                    "z. B. ST-86D86F60B492EFBC",  
  
                verify_btn:  
                    "Verifizieren",  
  
                verify_hint:  
                    "Ein SinoTrust-Eintrag unterstützt die digitale Verifizierung und ersetzt keine gesetzlich vorgeschriebenen Produktzertifizierungen.",  
  
                verify_invalid:  
                    "Geben Sie einen gültigen SinoTrust-Verifizierungscode ein.",  
            ...
            fr: {  
                ...
                verify_title:  
                    "Vérifier un enregistrement SinoTrust Europe",  
  
                verify_desc:  
                    "Saisissez le code figurant sur le certificat, le badge numérique ou le QR code afin de consulter le statut public de l’enregistrement SinoTrust.",  
  
                verify_label:  
                    "Code de vérification",  
  
                verify_placeholder:  
                    "Ex. ST-86D86F60B492EFBC",  
  
                verify_btn:  
                    "Vérifier",  
  
                verify_hint:  
                    "Un enregistrement SinoTrust facilite la vérification numérique et ne remplace pas les certifications de produit légalement obligatoires.",  
  
                verify_invalid:  
                    "Saisissez un code de vérification SinoTrust valide.",  
        ...
        document.addEventListener(  
            ...
            async () => {  
                ...
                /*  
                VERIFICA PUBBLICA CERTIFICATI  
                Reindirizza esclusivamente alla route pubblica già esistente  
                /verify/{code}; nessuna logica di validazione del certificato  
                viene duplicata nel browser.  
                */  
                ...
                const publicVerificationCode =  
                    document.getElementById(  
                        "publicVerificationCode"  
                    );  
  
                const publicVerificationError =  
                    document.getElementById(  
                ...
                if (  
                    ...
                    publicVerificationCode.addEventListener(  
                        "input",  
                        () => {  
                            publicVerificationError.textContent = "";  
                            publicVerificationCode.removeAttribute("aria-invalid");  
                        }  
                    );  
  
                    publicVerificationForm.addEventListener(  
                        "submit",  
                        event => {  
                            event.preventDefault();  
                            ...
                            const isValid =  
                                /^(?:DEMO-)?ST-[A-Z0-9]{8,64}$/.test(code);  
  
                            if (!isValid) {  
                                const selectedLanguage =  
                                    translations[langSelect?.value]  
                                        ? langSelect.value  
                                        : "it";  
  
                                publicVerificationError.textContent =  
                                    translations[selectedLanguage].verify_invalid  
                                    || translations.it.verify_invalid;  
  
                                publicVerificationCode.setAttribute(  
                                    "aria-invalid",  
                                    "true"  
                                );  
                                publicVerificationCode.focus();  
                                return;  
                            }  
    ...
    .st-certificates-card{background:linear-gradient(180deg,#ffffff 0%,#f8fafc 100%)}  
    .st-certificates-intro{margin:0 0 14px;color:#64748b;font-size:13px;line-height:1.55}  
    .st-certificates-grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(300px,1fr));gap:14px}  
    .st-certificate{display:grid;grid-template-columns:minmax(0,1fr) 104px;gap:16px;align-items:center;border:1px solid #dbe3ee;border-radius:12px;padding:16px;background:#fff;box-shadow:0 8px 24px rgba(15,23,42,.05)}  
    .st-certificate-main{min-width:0}  
    .st-certificate-title{display:flex;align-items:center;flex-wrap:wrap;gap:8px;margin-bottom:7px;color:#0f172a;font-size:14px}  
    .st-certificate-meta{display:grid;gap:5px;color:#475569;font-size:12px;line-height:1.45}  
    .st-certificate-code{display:inline-flex;align-items:center;max-width:100%;padding:5px 8px;border-radius:6px;background:#f1f5f9;color:#0f172a;font-family:ui-monospace,SFMono-Regular,Menlo,Consolas,monospace;font-weight:700;letter-spacing:.02em;word-break:break-all}  
    .st-certificate-actions{display:flex;flex-wrap:wrap;gap:7px;margin-top:12px}  
    .st-cert-action{display:inline-flex;align-items:center;justify-content:center;border:1px solid #cbd5e1;border-radius:7px;background:#fff;color:#0f172a;padding:8px 10px;font-size:12px;font-weight:700;text-decoration:none;cursor:pointer;transition:border-color .18s,transform .18s,box-shadow .18s}  
    .st-cert-action:hover{border-color:#94a3b8;transform:translateY(-1px);box-shadow:0 4px 10px rgba(15,23,42,.06)}  
    .st-cert-action.primary{background:#0f172a;border-color:#0f172a;color:#fff}  
    .st-cert-action.gold{background:#d4af37;border-color:#d4af37;color:#0f172a}  
    .st-cert-qr{width:104px;height:104px;border:1px solid #e2e8f0;border-radius:10px;background:#fff;padding:7px;object-fit:contain}  
    ...
    <section id="saasWorkspace">  
      ...
      <div class="saas-grid">  
        ...
        <div class="saas-card saas-wide st-certificates-card">  
          <h4>My Certificates</h4>  
          <p class="st-certificates-intro">Approved SinoTrust records appear here automatically with their verification code, public verification link, certificate PDF and QR code.</p>  
          <div id="stCertificates" class="st-certificates-grid">  
            <div class="st-cert-empty">Login to load your certificates.</div>  
          </div>  
        </div>  
    ...
    async function stLogout(){try{await stApi('/api/saas/logout',{method:'POST'});stLatestCase=null;stLatestProduct=null;stLatestCompany=null;stAuthStatus.textContent='Logged out';stData.textContent='Login to load your workspace.';const certHost=document.getElementById('stCertificates');if(certHost)certHost.innerHTML='<div class="st-cert-empty">Login to load your certificates.</div>';stNotifications.textContent=''}catch(e){stAuthStatus.textContent=e.message}}  
    ...
    function stCertificateDate(value){  
      if(!value)return '—';  
      const d=new Date(value);  
      if(Number.isNaN(d.getTime()))return stEsc(value);  
      try{return new Intl.DateTimeFormat(undefined,{year:'numeric',month:'2-digit',day:'2-digit'}).format(d)}  
      catch(_){return stEsc(value)}  
    }  
    async function stCopyVerificationCode(code,button){  
      const safe=stSafeVerificationCode(code);  
      if(!safe)return;  
      let copied=false;  
      try{  
      ...
      if(!copied){  
        ...
        area.value=safe;area.setAttribute('readonly','');area.style.position='fixed';area.style.opacity='0';  
    ...
    function stRenderCertificates(cases){  
      const host=document.getElementById('stCertificates');  
      if(!host)return;  
      ...
      host.innerHTML=rows.map(x=>{  
        const id=stSafeId(x.id),code=stSafeVerificationCode(x.verification_code);  
        if(!id||!code)return '';  
        const state=stCertificateState(x);  
        const product=stEsc(x.product_name||'SinoTrust verified product');  
        const model=stEsc(x.model||'');  
        const approved=stCertificateDate(x.approved_at);  
        const expires=stCertificateDate(x.expires_at);  
        const encoded=encodeURIComponent(code);  
        return `<article class="st-certificate">  
          <div class="st-certificate-main">  
            <div class="st-certificate-title"><b>${product}${model?' — '+model:''}</b><span class="saas-pill ${state.cls}">${state.label}</span></div>  
            <div class="st-certificate-meta">  
              <div><b>Verification code</b></div>  
              <div><span class="st-certificate-code">${stEsc(code)}</span></div>  
              <div>Approved: ${approved} · Valid until: ${expires}</div>  
            </div>  
            <div class="st-certificate-actions">  
              <a class="st-cert-action primary" href="/verify/${encoded}" target="_blank" rel="noopener noreferrer">Verify record</a>  
              <a class="st-cert-action gold" href="/api/saas/cases/${id}/certificate" target="_blank" rel="noopener noreferrer">Certificate PDF</a>  
              <button class="st-cert-action" type="button" onclick="stCopyVerificationCode('${code}',this)">Copy code</button>  
              <a class="st-cert-action" href="/api/saas/cases/${id}/verification-qr.png" target="_blank" rel="noopener noreferrer">Open QR</a>  
            </div>  
          </div>  
          <a href="/verify/${encoded}" target="_blank" rel="noopener noreferrer" aria-label="Verify ${stEsc(code)}">  
            <img class="st-cert-qr" src="/api/saas/cases/${id}/verification-qr.png" alt="QR code for ${stEsc(code)}" loading="lazy">  
          </a>  
        </article>`;  
      }).join('');  
    }  
  
    async function stRefresh(){try{let w=await stApi('/api/saas/workspace');stRenderCertificates(w.cases);stLatestCompany=w.companies?.[0]?.id||stLatestCompany;stLatestProduct=w.products?.[0]?.id||stLatestProduct;stLatestCase=w.cases?.[0]?.id||stLatestCase;stData.innerHTML=[...w.cases.map(x=>{const id=stSafeId(x.id),code=stSafeVerificationCode(x.verification_code);return `<div class="saas-item"><b>Case #${id??''}</b> — ${stEsc(x.product_name)} <span class="saas-pill">${stEsc(x.status)}</span> <span class="saas-pill">AI: ${stEsc(x.ai_status)}</span>${id&&code?` · <a href="/verify/${encodeURIComponent(code)}" target="_blank" rel="noopener noreferrer">Verify</a> · <a href="/api/saas/cases/${id}/certificate" target="_blank" rel="noopener noreferrer">PDF</a>`:''}</div>`}),...w.products.map(x=>`<div class="saas-item">Product: <b>${stEsc(x.name)}</b> ${stEsc(x.model||'')}</div>`)].join('')||'No records yet';stNotifications.innerHTML=w.notifications.map(n=>`<div class="saas-item"><b>${stEsc(n.title)}</b><br>${stEsc(n.body)}</div>`).join('')||'No notifications'}catch(e){stAuthStatus.textContent=e.message}}  
...
async def case_verification_qr(case_id:int,request:Request):  
    ...
    code=str(r["verification_code"]).strip()  
    if IS_DEMO_MODE and not code.startswith("DEMO-ST-"):  
    ...
    try:  
        ...
        return JSONResponse({"error":"qr_engine_unavailable","detail":"Install qrcode[pil] to enable PNG QR generation."},503)  
    verification_url=f"{PUBLIC_BASE_URL}/verify/{urllib.parse.quote(code,safe='')}"  
    ...
    return Response(  
        ...
        headers={  
            "Content-Disposition":f'inline; filename="SinoTrust-{code}-QR.png"',  
